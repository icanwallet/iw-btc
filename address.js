...
const bech32 = require('iwcrypto/bech32')
const bs58check = require('iwcrypto/bs58check')
const bscript = require('./script')
const networks = require('./networks')
const typeforce = require('iwcrypto/typeforce')
...
function mnemonicToSeedRoot(mnemonic, network) {
...
module.exports = {
	...
	mnemonicToSeedRoot: mnemonicToSeedRoot
}
